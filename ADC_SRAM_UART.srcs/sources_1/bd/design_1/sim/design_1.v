...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=13,numReposBlks=12,numNonXlnxBlks=1,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=4,da_board_cnt=4,da_clkrst_cnt=37,da_mb_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (A,
    BTN1,
    CONVST,
  ...
  wire [7:0]FPGA_ADC_interface_0_DATA;
  wire FPGA_ADC_interface_0_DONE;
  wire FPGA_ADC_interface_0_LAST;
  wire FPGA_ADC_interface_0_RD;
  wire FPGA_ADC_interface_0_RESET_OUT;
  wire FPGA_ADC_interface_0_VALID;
  wire Net;
  ...
  design_1_FPGA_ADC_interface_0_1 FPGA_ADC_interface_0
       (.A(FPGA_ADC_interface_0_A),
        ...
        .DATA(FPGA_ADC_interface_0_DATA),
        .DB(DB_1),
        .DONE(FPGA_ADC_interface_0_DONE),
        .ENABLE(BTN1_1),
        .EOC(EOC_1),
        .LAST(FPGA_ADC_interface_0_LAST),
        .RD(FPGA_ADC_interface_0_RD),
        .READY(axis_clock_converter_0_s_axis_tready),
        .RESET(rst_clk_wiz_1_100M_peripheral_reset),
        .RESET_OUT(FPGA_ADC_interface_0_RESET_OUT),
        .VALID(FPGA_ADC_interface_0_VALID));
  design_1_axis_clock_converter_0_0 axis_clock_converter_0
       (.m_axis_aclk(clk_wiz_1_clk_out1),
        ...
        .s_axis_tdata(FPGA_ADC_interface_0_DATA),
        .s_axis_tlast(FPGA_ADC_interface_0_LAST),
        .s_axis_tready(axis_clock_converter_0_s_axis_tready),
        .s_axis_tvalid(FPGA_ADC_interface_0_VALID));
  ...
  design_1_ila_0_0 ila_0
       (.clk(clk_wiz_1_clk_out1),
        ...
        .probe4(FPGA_ADC_interface_0_RESET_OUT),
        .probe5(axis_clock_converter_0_s_axis_tready),
