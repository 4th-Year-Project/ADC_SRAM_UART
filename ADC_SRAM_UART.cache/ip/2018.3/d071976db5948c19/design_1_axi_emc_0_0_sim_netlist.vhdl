...
architecture STRUCTURE of \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ld_arith_reg__parameterized0\ is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \DATAWIDTH_MATCH_GEN.addr_cnt_i[0]_i_5\ : label is "soft_lutpair62";
  attribute SOFT_HLUTNM of \FSM_sequential_crnt_state[0]_i_12\ : label is "soft_lutpair63";
  attribute SOFT_HLUTNM of \FSM_sequential_crnt_state[0]_i_15\ : label is "soft_lutpair61";
  attribute SOFT_HLUTNM of \FSM_sequential_crnt_state[1]_i_10\ : label is "soft_lutpair63";
  attribute SOFT_HLUTNM of \FSM_sequential_crnt_state[1]_i_7\ : label is "soft_lutpair60";
  attribute BOX_TYPE : string;
  attribute BOX_TYPE of \PERBIT_GEN[0].FF_RST0_GEN.FDRE_i1\ : label is "PRIMITIVE";
  attribute BOX_TYPE of \PERBIT_GEN[1].FF_RST0_GEN.FDRE_i1\ : label is "PRIMITIVE";
  attribute SOFT_HLUTNM of \PERBIT_GEN[1].FF_RST0_GEN.FDRE_i1_i_2\ : label is "soft_lutpair60";
  attribute BOX_TYPE of \PERBIT_GEN[1].MULT_AND_i1\ : label is "PRIMITIVE";
  attribute XILINX_LEGACY_PRIM : string;
  attribute XILINX_LEGACY_PRIM of \PERBIT_GEN[1].MULT_AND_i1\ : label is "MULT_AND";
  attribute XILINX_TRANSFORM_PINMAP : string;
  ...
  attribute SOFT_HLUTNM of \PERBIT_GEN[4].MULT_AND_i1_i_2\ : label is "soft_lutpair62";
  attribute SOFT_HLUTNM of read_data_en_reg_i_2 : label is "soft_lutpair61";
begin
...
architecture STRUCTURE of \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ld_arith_reg__parameterized2\ is
  ...
  signal \NLW_PERBIT_GEN[0].XORCY_i1_CARRY4_S_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_crnt_state[0]_i_4\ : label is "soft_lutpair64";
  attribute BOX_TYPE : string;
  attribute BOX_TYPE of \PERBIT_GEN[0].FF_RST0_GEN.FDRE_i1\ : label is "PRIMITIVE";
  attribute BOX_TYPE of \PERBIT_GEN[0].XORCY_i1_CARRY4\ : label is "PRIMITIVE";
  attribute OPT_MODIFIED : string;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_mem_state_machine is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \DATAWIDTH_MATCH_GEN.addr_cnt_i[0]_i_7\ : label is "soft_lutpair67";
  attribute SOFT_HLUTNM of \FSM_sequential_crnt_state[0]_i_2\ : label is "soft_lutpair88";
  attribute SOFT_HLUTNM of \FSM_sequential_crnt_state[0]_i_6\ : label is "soft_lutpair69";
  attribute SOFT_HLUTNM of \FSM_sequential_crnt_state[0]_i_9\ : label is "soft_lutpair76";
  attribute SOFT_HLUTNM of \FSM_sequential_crnt_state[1]_i_12\ : label is "soft_lutpair82";
  attribute SOFT_HLUTNM of \FSM_sequential_crnt_state[1]_i_2\ : label is "soft_lutpair71";
  attribute SOFT_HLUTNM of \FSM_sequential_crnt_state[1]_i_4\ : label is "soft_lutpair79";
  attribute SOFT_HLUTNM of \FSM_sequential_crnt_state[2]_i_5\ : label is "soft_lutpair75";
  attribute SOFT_HLUTNM of \FSM_sequential_crnt_state[2]_i_6\ : label is "soft_lutpair72";
  attribute SOFT_HLUTNM of \FSM_sequential_crnt_state[2]_i_7\ : label is "soft_lutpair70";
  attribute SOFT_HLUTNM of \FSM_sequential_crnt_state[3]_i_2\ : label is "soft_lutpair71";
  attribute SOFT_HLUTNM of \FSM_sequential_crnt_state[4]_i_2\ : label is "soft_lutpair89";
  ...
  attribute SOFT_HLUTNM of \PERBIT_GEN[1].FF_RST0_GEN.FDRE_i1_i_5\ : label is "soft_lutpair79";
  attribute SOFT_HLUTNM of \PERBIT_GEN[1].MUXCY_i1_i_7\ : label is "soft_lutpair82";
  attribute SOFT_HLUTNM of \PERBIT_GEN[1].MUXCY_i1_i_8\ : label is "soft_lutpair78";
  attribute SOFT_HLUTNM of \PERBIT_GEN[4].FF_RST0_GEN.FDRE_i1_i_1__0\ : label is "soft_lutpair87";
  attribute SOFT_HLUTNM of \PERBIT_GEN[4].FF_RST0_GEN.FDRE_i1_i_1__1\ : label is "soft_lutpair83";
  attribute SOFT_HLUTNM of \PERBIT_GEN[4].FF_RST1_GEN.FDSE_i1_i_1\ : label is "soft_lutpair87";
  attribute SOFT_HLUTNM of \PERBIT_GEN[4].FF_RST1_GEN.FDSE_i1_i_1__0\ : label is "soft_lutpair84";
  attribute SOFT_HLUTNM of \PERBIT_GEN[7].MULT_AND_i1_i_13\ : label is "soft_lutpair69";
  attribute SOFT_HLUTNM of \PERBIT_GEN[7].MULT_AND_i1_i_14\ : label is "soft_lutpair80";
  attribute SOFT_HLUTNM of \PERBIT_GEN[7].MULT_AND_i1_i_8\ : label is "soft_lutpair85";
  attribute SOFT_HLUTNM of \PERBIT_GEN[7].MULT_AND_i1_i_9\ : label is "soft_lutpair85";
  attribute SOFT_HLUTNM of \RDDATA_PATH_MUX_GEN.ASYNC_ADDR_CNT_GEN.addr_cnt_d1[0]_i_11\ : label is "soft_lutpair80";
  attribute SOFT_HLUTNM of \RDDATA_PATH_MUX_GEN.ASYNC_ADDR_CNT_GEN.addr_cnt_d1[0]_i_13\ : label is "soft_lutpair74";
  attribute SOFT_HLUTNM of \RDDATA_PATH_MUX_GEN.ASYNC_ADDR_CNT_GEN.addr_cnt_d1[0]_i_16\ : label is "soft_lutpair73";
  attribute SOFT_HLUTNM of \RDDATA_PATH_MUX_GEN.ASYNC_ADDR_CNT_GEN.addr_cnt_d1[0]_i_19\ : label is "soft_lutpair77";
  attribute SOFT_HLUTNM of \RDDATA_PATH_MUX_GEN.ASYNC_ADDR_CNT_GEN.addr_cnt_d1[0]_i_20\ : label is "soft_lutpair66";
  attribute SOFT_HLUTNM of \RDDATA_PATH_MUX_GEN.ASYNC_ADDR_CNT_GEN.addr_cnt_d1[0]_i_3\ : label is "soft_lutpair67";
  attribute SOFT_HLUTNM of \RDDATA_PATH_MUX_GEN.ASYNC_ADDR_CNT_GEN.addr_cnt_d1[0]_i_6\ : label is "soft_lutpair83";
  attribute SOFT_HLUTNM of \RDDATA_PATH_MUX_GEN.ASYNC_ADDR_CNT_GEN.addr_cnt_d1[0]_i_8\ : label is "soft_lutpair77";
  attribute BOX_TYPE : string;
  ...
  attribute SOFT_HLUTNM of \READ_COMPLETE_PIPE_GEN[0].READ_COMPLETE_PIPE_i_2\ : label is "soft_lutpair81";
  ...
  attribute SOFT_HLUTNM of \mem_ce_reg[0]_i_3\ : label is "soft_lutpair68";
  attribute SOFT_HLUTNM of \mem_ce_reg[0]_i_4\ : label is "soft_lutpair81";
  attribute SOFT_HLUTNM of mem_dqt_t_d_i_1 : label is "soft_lutpair74";
  attribute SOFT_HLUTNM of \mem_oen_reg[0]_i_4\ : label is "soft_lutpair70";
  attribute SOFT_HLUTNM of \mem_oen_reg[0]_i_5\ : label is "soft_lutpair88";
  attribute SOFT_HLUTNM of mem_rnw_reg_i_1 : label is "soft_lutpair73";
  attribute SOFT_HLUTNM of new_page_d1_i_3 : label is "soft_lutpair84";
  attribute SOFT_HLUTNM of new_page_d1_i_4 : label is "soft_lutpair89";
  attribute SOFT_HLUTNM of new_page_d1_i_5 : label is "soft_lutpair76";
  attribute SOFT_HLUTNM of s_axi_mem_arready_INST_0_i_2 : label is "soft_lutpair66";
  attribute SOFT_HLUTNM of s_axi_mem_wready_INST_0_i_3 : label is "soft_lutpair68";
  attribute SOFT_HLUTNM of transaction_done_reg_i_2 : label is "soft_lutpair86";
  attribute SOFT_HLUTNM of wlast_reg_i_3 : label is "soft_lutpair86";
  attribute SOFT_HLUTNM of wlast_reg_i_4 : label is "soft_lutpair72";
  attribute SOFT_HLUTNM of wlast_reg_i_6 : label is "soft_lutpair75";
begin
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ipic_if is
  ...
  signal \^pend_wrreq_reg_0\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \DATAWIDTH_MATCH_GEN.addr_cnt_i[0]_i_8\ : label is "soft_lutpair65";
  attribute SOFT_HLUTNM of wlast_reg_i_5 : label is "soft_lutpair65";
begin
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_emc_native_interface is
  ...
  attribute SOFT_HLUTNM of \BEN_STORE_GEN[1].BEN_REG_i_1\ : label is "soft_lutpair58";
  attribute SOFT_HLUTNM of \BEN_STORE_GEN[2].BEN_REG_i_1\ : label is "soft_lutpair59";
  attribute SOFT_HLUTNM of \BEN_STORE_GEN[3].BEN_REG_i_1\ : label is "soft_lutpair58";
  attribute SOFT_HLUTNM of \DATAWIDTH_MATCH_GEN.addr_cnt_i[0]_i_3\ : label is "soft_lutpair49";
  attribute SOFT_HLUTNM of \DATAWIDTH_MATCH_GEN.addr_cnt_i[1]_i_2\ : label is "soft_lutpair46";
  attribute SOFT_HLUTNM of \FSM_sequential_emc_addr_ps[1]_i_10\ : label is "soft_lutpair40";
  attribute SOFT_HLUTNM of \FSM_sequential_emc_addr_ps[1]_i_11\ : label is "soft_lutpair41";
  attribute SOFT_HLUTNM of \FSM_sequential_emc_addr_ps[1]_i_12\ : label is "soft_lutpair39";
  attribute SOFT_HLUTNM of \FSM_sequential_emc_addr_ps[1]_i_13\ : label is "soft_lutpair51";
  attribute SOFT_HLUTNM of \FSM_sequential_emc_addr_ps[1]_i_15\ : label is "soft_lutpair50";
  attribute SOFT_HLUTNM of \FSM_sequential_emc_addr_ps[1]_i_3\ : label is "soft_lutpair44";
  attribute SOFT_HLUTNM of \FSM_sequential_emc_addr_ps[1]_i_5\ : label is "soft_lutpair50";
  attribute SOFT_HLUTNM of \FSM_sequential_emc_addr_ps[1]_i_8\ : label is "soft_lutpair55";
  ...
  attribute SOFT_HLUTNM of \PERBIT_GEN[0].XORCY_i1_i_2\ : label is "soft_lutpair49";
  attribute SOFT_HLUTNM of \PERBIT_GEN[1].MUXCY_i1_i_3\ : label is "soft_lutpair46";
  attribute SOFT_HLUTNM of addr_sm_ps_IDLE_reg_i_2 : label is "soft_lutpair55";
  attribute SOFT_HLUTNM of addr_sm_ps_IDLE_reg_i_3 : label is "soft_lutpair47";
  ...
  attribute SOFT_HLUTNM of \burst_addr_cnt[0]_i_1\ : label is "soft_lutpair42";
  ...
  attribute SOFT_HLUTNM of \burstlength_reg[2]_i_1\ : label is "soft_lutpair56";
  attribute SOFT_HLUTNM of \burstlength_reg[3]_i_1\ : label is "soft_lutpair38";
  attribute SOFT_HLUTNM of \burstlength_reg[5]_i_1\ : label is "soft_lutpair39";
  attribute SOFT_HLUTNM of \burstlength_reg[6]_i_1\ : label is "soft_lutpair56";
  attribute SOFT_HLUTNM of \burstlength_reg[7]_i_1\ : label is "soft_lutpair41";
  attribute SOFT_HLUTNM of \bus2ip_BE_reg[1]_i_2\ : label is "soft_lutpair43";
  ...
  attribute SOFT_HLUTNM of \bus2ip_BE_reg[3]_i_5\ : label is "soft_lutpair43";
  attribute SOFT_HLUTNM of \derived_burst_reg[0]_i_1\ : label is "soft_lutpair57";
  ...
  attribute SOFT_HLUTNM of s_axi_mem_arready_INST_0_i_1 : label is "soft_lutpair48";
  attribute SOFT_HLUTNM of s_axi_mem_awready_INST_0 : label is "soft_lutpair44";
  attribute SOFT_HLUTNM of s_axi_mem_bvalid_reg_i_1 : label is "soft_lutpair47";
  attribute SOFT_HLUTNM of s_axi_mem_wready_INST_0 : label is "soft_lutpair48";
begin
  Bus2IP_RdReq_emc <= \^bus2ip_rdreq_emc\;
...
\FSM_sequential_emc_addr_ps[2]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFF57"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute x_core_info of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "axi_emc,Vivado 2018.3";
