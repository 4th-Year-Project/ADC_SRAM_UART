...
HD_PWD='C:/FPGA_Projects/ADC_SRAM_UART/ADC_SRAM_UART.runs/design_1_axi_fifo_mm_s_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_fifo_mm_s_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_fifo_mm_s_0_1.tcl
